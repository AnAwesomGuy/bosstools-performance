...
@Pseudo
@Mixin(targets = "net.mrscauthd.boss_tools.skyrenderer.ClientEventBusMarsOrbit$1")
public abstract class ClientEventBusMarsOrbit$1Mixin extends DimensionRenderInfo {
    ...
    private ClientEventBusMarsOrbit$1Mixin() {
