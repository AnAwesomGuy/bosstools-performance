...
@Pseudo
@Mixin(targets = "net.mrscauthd.boss_tools.skyrenderer.ClientEventBusVenusOrbit$1")
public abstract class ClientEventBusVenusOrbit$1Mixin extends DimensionRenderInfo {
